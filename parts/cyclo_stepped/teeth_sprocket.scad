...
nring=17; // teeth in bottom ring gear
...
mateR = 1.3; // amount of tooth engagement on each side of centerline
handoffInset=0.5; // shift teeth this far (bigger=easier clearance, but more axial force)
...
function tooth_ID_gRT() = handoffRT-mateR-handoffS-tooth_clearance;
function solidOD() = 2*(handoffRB-Pshift-mateR-handoffS-tooth_clearance);
...
module toothspot_bottom() { translate([Pshift,0,0]) children(); }
module toothspot_top() { translate([Pshift,0,0]) children(); }
